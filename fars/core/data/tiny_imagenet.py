...
if __name__ == '__main__':
    path = '/gpfsscratch/rech/yxj/uuc79vj/data/tiny-imagenet'
    train_dataset = TinyImageNet(path, split='train', download=True)
    test_dataset = TinyImageNet(path, split='val', download=True)
